...
w("ies-r.en.json", {
  meta: {
    id: "ies-r", name: "IES-R Impact of Event Scale - Revised", fullName: "Impact of Event Scale - Revised",
    description: "The IES-R is a 22-item self-report measure that assesses subjective distress caused by traumatic events. It measures three dimensions of post-traumatic stress: intrusion, avoidance, and hyperarousal.",
    author: "Weiss & Marmar (1997)", license: "Free to use",
    reference: "Weiss DS, Marmar CR. The Impact of Event Scale-Revised. In: Wilson JP, Keane TM, eds. Assessing Psychological Trauma and PTSD. New York: Guilford Press; 1997:399-411.",
    instruction: "Below is a list of difficulties people sometimes have after stressful life events. Please read each item and then indicate how distressing each difficulty has been for you during the past 7 days with respect to the event you experienced."
  },
  ...
  interpretation: {
    ...
    subscaleRanges: {
      intrusion: [
        {min:0,max:8,level:"normal",label:"Low",description:"Intrusion symptoms are within the normal range."},
        {min:9,max:16,level:"mild",label:"Mild",description:"Some intrusive thoughts, memories, or dreams related to the event."},
        {min:17,max:24,level:"moderate",label:"Moderate",description:"Notable intrusive symptoms that may disrupt daily life."},
        {min:25,max:32,level:"severe",label:"Severe",description:"Severe intrusion symptoms significantly impacting functioning."}
      ],
      avoidance: [
        {min:0,max:8,level:"normal",label:"Low",description:"Avoidance symptoms are within the normal range."},
        {min:9,max:16,level:"mild",label:"Mild",description:"Some avoidance of reminders related to the event."},
        {min:17,max:24,level:"moderate",label:"Moderate",description:"Notable avoidance patterns that may limit activities."},
        {min:25,max:32,level:"severe",label:"Severe",description:"Severe avoidance significantly restricting daily life."}
      ],
      hyperarousal: [
        {min:0,max:6,level:"normal",label:"Low",description:"Hyperarousal symptoms are within the normal range."},
        {min:7,max:12,level:"mild",label:"Mild",description:"Some hyperarousal symptoms such as difficulty sleeping or irritability."},
        {min:13,max:18,level:"moderate",label:"Moderate",description:"Notable hyperarousal affecting daily functioning."},
        {min:19,max:24,level:"severe",label:"Severe",description:"Severe hyperarousal symptoms."}
      ]
    }
  },
